...
switch (_p_en) do {
	...
	case "UK3CB_TKM_O" : {
        btc_type_motorized = btc_type_motorized + ["UK3CB_TKA_O_L39_PYLON","UK3CB_TKA_O_Antonov_AN2","UK3CB_TKA_O_C130J","UK3CB_TKA_O_C130J_CARGO"];
